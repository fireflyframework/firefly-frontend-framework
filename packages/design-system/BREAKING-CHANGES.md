...
- Pre-1.0 versions may include breaking changes inside minor bumps; they are still listed here.
- For this package, a breaking change includes: renaming/removing an `Ff*Component`, changing a public input/output name or type, renaming an SCSS token, changing the M3 bridge mapping.
